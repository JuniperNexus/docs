...
const config: DocsThemeConfig = {
  ...
  head: () => {
    ...
    const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://junipernexus.github.io/docs'
  ...
  footer: {
    text: (
      <span>
        Copyright © {new Date().getFullYear()} Juniper Nexus. All rights reserved.
      </span>
    ),
  },
}
